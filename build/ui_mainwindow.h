...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(915, 660);
        MainWindow->setMaximumSize(QSize(915, 660));
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/images/disconnect.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        scrollableRegion->setGeometry(QRect(0, 0, 911, 581));
        ...
        tableWidget->setGeometry(QRect(0, 230, 911, 171));
        ...
        tabWidget_2 = new QTabWidget(scrollableRegion);
        tabWidget_2->setObjectName(QStringLiteral("tabWidget_2"));
        tabWidget_2->setGeometry(QRect(0, 410, 911, 171));
        tab_2 = new QWidget();
        tab_2->setObjectName(QStringLiteral("tab_2"));
        textEdit_3 = new QTextEdit(tab_2);
        textEdit_3->setObjectName(QStringLiteral("textEdit_3"));
        textEdit_3->setGeometry(QRect(0, 0, 907, 151));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget_2->setTabText(tabWidget_2->indexOf(tab_2), QApplication::translate("MainWindow", "Sniffer View", 0));
        tabWidget_2->setTabText(tabWidget_2->indexOf(tab_3), QApplication::translate("MainWindow", "System View", 0));
